package com.zeiss.cms.generator;
...
import com.zeiss.cms.commons.generator.AutoGenerator;
import com.zeiss.cms.commons.generator.InjectionConfig;
...
//        strategy.setInclude(new String[] { "order_shop_detail" }); // 需要生成的表
        ...
        // 自定义 controller 父类
         strategy.setSuperControllerClass("com.zeiss.cms.commons.base.BaseController");
