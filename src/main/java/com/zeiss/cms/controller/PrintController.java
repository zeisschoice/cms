...
import com.zeiss.cms.commons.utils.Trans2RMBUtils;
import com.zeiss.cms.model.Building;
import com.zeiss.cms.model.Cost;
import com.zeiss.cms.model.CostPrint;
//import com.zeiss.cms.model.JavaBeanPerson;
...
//		Cost c = mapper.readValue(cost,Cost.class);
		...
		Cost c = iCostService.selectById(Integer.valueOf(cost));
		...
		cp.setWriteBiller(getStaffName());
