package com.zeiss.cms.commons.utils;
/**
 * 程序目的：
...
public  class Trans2RMBUtils {
	...
	public static void main(String[] args) {
		System.out.println("\n--------将数字转换成中文金额的大写形式------------\n");
		Trans2RMBUtils t2r = new Trans2RMBUtils();
		String s = cleanZero(splitNum(roundString(getNum("332322323.09"))))+"整";
		// 如果转换过后是一个空串，则不输出屏幕
		if(!"".equals(s)) {
	...
	public static String trans2RMB(String num){
		...
		String s = cleanZero(splitNum(roundString(getNum(num))))+"整";
